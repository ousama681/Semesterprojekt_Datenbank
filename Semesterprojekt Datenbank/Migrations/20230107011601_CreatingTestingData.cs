    ...
    public partial class CreatingTestingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Onkyo TX-NR6100', 18701693, 680, 3, 1)," +
                                 "('Philips AZB798T/12', 5706598, 680, 3, 1)," +
                                 "('Philips TAR5505', 13389262, 69.80, 3, 1)" +
                                 ";");
            ...
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Cambridge Audio AXC35', 11291462, 358, 4, 1)," +
                                 "('Bose Cushion Kit QuietComfort 35', 8270154, 49, 4, 1)," +
                                 "('Sandberg Bluetooth Audio Link 2in1 TxRx', 20709163, 35.30, 4 , 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup Car HiFi
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Pioneer SPH-DA360DAB', 21734230, 369, 5, 1)," +
                                 "('Blaupunkt Bremen SQR 46 DAB', 11231189, 392, 5, 1)," +
                                 "('Pure Highway 600', 6212562, 62.60, 5, 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup DJ
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Hercules DJ Learning Kit', 12795103, 187, 6, 1)," +
                                 "('Pioneer DJ DDJ-REV1', 18490189, 318, 6, 1)," +
                                 "('Razer Audio Mixer', 19976690, 227, 6, 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup Gehäuse
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Lian-Li PC-O11DX', 8393857, 159, 7, 1)," +
                                 "('be quiet! Pure Base', 13168983, 109, 7, 1)," +
                                 "('NZXT H7 CM-H71FB-01', 21020148, 149, 7, 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup RAM
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('Corsair Vengeance RGB Pro', 12513501, 114, 11, 1)," +
                                 "('G.Skill Trident Z5 NEO RGB', 22433066, 325, 11, 1)," +
                                 "('Kingston FURY Beast', 18014221, 189, 11, 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup Grafikkarte
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('ASUS GeForce ROG STRIX RTX 3070 Ti', 16001074, 755, 8, 1)," +
                                 "('Sapphire AMD RADEON RX 7900 XT MBA', 23484990, 1039, 8, 1)," +
                                 "('KFA2 RTX4090 SG OC', 22706103, 2099, 8, 1)" +
                                 ";");

            // TestingData for Articles in ArticleGroup MainBoard
            migrationBuilder.Sql("INSERT INTO dbo.Article(Name, Nr, Price, ArticleGroupId, Mwstid)" +
                                 "VALUES" +
                                 "('ASUS Prime Z790-P', 22514027, 284, 9, 1)," +
                                 "('ASUS ROG CROSSHAIR VIII DARK HERO', 14168846, 353, 9, 1)," +
                                 "('ASUS ROG Strix B550-F Gaming Wifi II', 17442536, 191, 9, 1)" +
                                  ";");
